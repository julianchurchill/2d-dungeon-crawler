...
export class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    createModernTileTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createHdTileTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    ...
    createModernTileTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createHdEntityTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createClassicItemTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createModernTileTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createHdItemTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
