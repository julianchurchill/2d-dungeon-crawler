...
export class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    createModernEntityTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    this._createHdEntityTextures();
    createClassicItemTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
    createModernItemTextures((key, w, h, drawFn) => { this._genTextureWithGfx(key, w, h, drawFn, this._gfx()) });
