...
const S = 32; // HD tile size in pixels

/**
 * Texture generation functions for the HD tile set.
 */
 ...
 */
export function createHdTileTextures(generateTextureFn) {
  // Dungeon floor — large stone slabs with mortar grid and surface detail
  generateTextureFn('hd_tile_floor', S, S, (g) => {
    // Mortar background
  ...
  generateTextureFn('hd_tile_wall', S, S, (g) => {
    // Stone base
  ...
  generateTextureFn('hd_tile_stairs', S, S, (g) => {
    // Background stone
    g.fillStyle(0x0e1018);
    g.fillRect(0, 0, S, S);
  ...
  generateTextureFn('hd_tile_stairs_up', S, S, (g) => {
    g.fillStyle(0x0e1018);
    g.fillRect(0, 0, S, S);
    const steps = [
      { y: 2,  w: 28, x: 2 },
  ...
  generateTextureFn('hd_tile_town_floor', S, S, (g) => {
    // Mortar
  ...
  generateTextureFn('hd_tile_town_wall', S, S, (g) => {
    // Mortar
  ...
  generateTextureFn('hd_tile_town_stairs', S, S, (g) => {
  ...
  generateTextureFn('hd_tile_shop_roof', S, S, (g) => {
  ...
  generateTextureFn('hd_tile_town_accent', S, S, (g) => {
  ...
  generateTextureFn('hd_tile_door_potion', S, S, (g) => {
    drawHdDoorBase(g, S);
  ...
  generateTextureFn('hd_tile_door_weapon', S, S, (g) => {
    drawHdDoorBase(g, S);
    // Blade
  ...
  generateTextureFn('hd_tile_door_armour', S, S, (g) => {
    drawHdDoorBase(g, S);
 ...
 * @param {function(string, number, number, function(Phaser.GameObjects.Graphics)):void} generateTextureFn
 */
export function createHdEntityTextures(generateTextureFn) {
  // Player — diamond with faceted shading and bright pupil
  generateTextureFn('hd_entity_player', S, S, (g) => {
    // Dark outline
  ...
  generateTextureFn('hd_entity_cockroach', S, S, (g) => {
    // Body shadow
  ...
  generateTextureFn('hd_entity_sprite', S, S, (g) => {
    // Wing glow aura
  ...
  generateTextureFn('hd_entity_goblin', S, S, (g) => {
    // Body shadow
  ...
  generateTextureFn('hd_entity_orc', S, S, (g) => {
    // Shadow
  ...
  generateTextureFn('hd_entity_troll', S, S, (g) => {
    // Shadow
  ...
  generateTextureFn('hd_entity_skeleton', S, S, (g) => {
    // Dark background
  ...
  generateTextureFn('hd_entity_skeleton_warrior', S, S, (g) => {
    // Dark silhouette
    g.fillStyle(0x0a0a0a);
  ...
  generateTextureFn('hd_entity_skeleton_mage', S, S, (g) => {
    // Dark silhouette
  ...
  generateTextureFn('hd_entity_old_bones', S, S, (g) => {
    // Large shadow
  ...
  generateTextureFn('hd_entity_creeping_mass', S, S, (g) => {
    // Outer dark shell
  ...
  generateTextureFn('hd_entity_spitter', S, S, (g) => {
    // Dark outer shell
  ...
  generateTextureFn('hd_entity_npc_elder', S, S, (g) => {
  ...
  generateTextureFn('hd_entity_npc_guard', S, S, (g) => {
    // Shadow
  ...
  generateTextureFn('hd_entity_npc_merchant', S, S, (g) => {
    // Shadow
  ...
  generateTextureFn('hd_entity_npc_warrior', S, S, (g) => {
    // Shadow
 ...
 * @param {function(string, number, number, function(Phaser.GameObjects.Graphics)):void} generateTextureFn
 */
export function createHdItemTextures(generateTextureFn) {
  // Health potion — ruby vial with glass caustic and bubbles
  generateTextureFn('hd_item_potion_health', S, S, (g) => {
    // Outline shadow
  ...
  generateTextureFn('hd_item_weapon', S, S, (g) => {
    // Blade shadow
  ...
  generateTextureFn('hd_item_armor', S, S, (g) => {
    // Outline
  ...
  generateTextureFn('hd_item_ranged_weapon', S, S, (g) => {
    // Bow stave shadow
  ...
  generateTextureFn('hd_item_bone_blade', S, S, (g) => {
    // Blade shadow
  ...
  generateTextureFn('hd_item_night_cloak', S, S, (g) => {
    // Outline
  ...
  generateTextureFn('hd_item_null_scimitar', S, S, (g) => {
    // Blade shadow
  ...
  generateTextureFn('hd_item_key_to_elsewhere', S, S, (g) => {
    // Outline
    g.fillStyle(0x331100);
  ...
  generateTextureFn('hd_item_eclipse_blade', S, S, (g) => {
  ...
  generateTextureFn('hd_item_key_to_beyond', S, S, (g) => {
    // Outline
    g.fillStyle(0x0a0a0a);
  ...
  generateTextureFn('hd_item_skeleton_shield', S, S, (g) => {
    // Outline
  ...
  generateTextureFn('hd_item_potion_teleport', S, S, (g) => {
    // Outline
  ...
  generateTextureFn('hd_item_home_seeking_scroll', S, S, (g) => {
    // Drop shadow
  ...
  generateTextureFn('hd_item_helmet', S, S, (g) => {
    g.fillStyle(0x334455);
  ...
  generateTextureFn('hd_item_chest', S, S, (g) => {
    g.fillStyle(0x334455);
  ...
  generateTextureFn('hd_item_legs', S, S, (g) => {
    g.fillStyle(0x334455);
  ...
  generateTextureFn('hd_item_arms', S, S, (g) => {
    g.fillStyle(0x334455);
  ...
  generateTextureFn('hd_item_boots', S, S, (g) => {
    g.fillStyle(0x334455);
  ...
  generateTextureFn('hd_item_ring', S, S, (g) => {
  ...
  generateTextureFn('hd_item_amulet', S, S, (g) => {
    g.fillStyle(0x775500);
